...
// Behavior: input baru no-decimal; business rules dan schema/backend SQLite tetap sama.
...
const Returns = () => {
  ...
  // - dokumen retur, update stok, dan inventory log wajib commit bersama lewat backend SQLite;
  // - tidak memakai addInventoryLog/updateInventoryStock langsung agar tidak ada stok berubah tanpa audit log.
  // ARSIP HISTORIS:
  // - flow lama melakukan update stok lebih dulu, lalu menyimpan retur/log terpisah; jika salah satu gagal, stok bisa tidak sinkron.
  // AKTIF:
        ...
        >
          ...
          {selectedItem ? (
            /* IMS NOTE [AKTIF/GUARDED] - Snapshot stok Returns.
               ...
               Hubungan flow: hanya mengubah presentasi UI; transaction retur, stock revert, inventory log, validasi, dan payload retur tidak berubah.
               Alasan logic: stok sebelum retur adalah info kontekstual, bukan warning/error, sehingga aman dibuat collapse agar form mobile lebih ringkas.
            ...
            >
              <Collapse.Panel
                key="return-stock-preview"
                header="Lihat stok item"
                extra={
