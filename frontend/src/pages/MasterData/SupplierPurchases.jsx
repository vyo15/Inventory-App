...
import SupplierPriceCheckModal from "./components/SupplierPriceCheckModal";
...
import { getMaterialStockUnit } from './helpers/supplierPurchasesPageHelpers';
...
<SupplierFormModal
        ...
        getItemStockUnit={getItemStockUnit}
        getVariantOptions={getVariantOptions}
        handleSaveSupplier={handleSaveSupplier}
        isEditing={isEditing}
        modalVisible={modalVisible}
        saving={saving}
        updateCatalogOfferAtIndex={updateCatalogOfferAtIndex}
      />
...
<SupplierPriceCheckModal
        handlePriceCheck={handlePriceCheck}
        priceCheckForm={priceCheckForm}
        priceCheckOffer={priceCheckOffer}
        priceCheckSaving={priceCheckSaving}
        priceCheckVisible={priceCheckVisible}
        setPriceCheckOffer={setPriceCheckOffer}
        setPriceCheckVisible={setPriceCheckVisible}
      />
    </div>
  );
};
