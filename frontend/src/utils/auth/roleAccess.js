...
// - GUARDED: role baru tidak boleh ditambah tanpa update access matrix docs, route guard, menu guard, User Management, dan guard akses layanan lokal.
...
export const ROUTE_ACCESS_KEYS = {
  ...
  TRANSACTIONS_HUB: "transactions-hub",
  ...
  CASH_IN: "cash-in",
  CASH_OUT: "cash-out",
  MONEY_MOVEMENT_LEDGER: "money-movement-ledger",
...
// - GUARDED: UI guard ini belum menggantikan guard akses layanan lokal.
// =========================
export const ROUTE_ROLE_ACCESS = {
  [ROUTE_ACCESS_KEYS.DASHBOARD]: ROLE_GROUPS.ALL_AUTHENTICATED,

  [ROUTE_ACCESS_KEYS.MASTER_DATA_HUB]: ROLE_GROUPS.ADMIN_ONLY,
  [ROUTE_ACCESS_KEYS.INVENTORY_HUB]: ROLE_GROUPS.OPERATIONAL_DAILY,
  [ROUTE_ACCESS_KEYS.PRODUCTION_HUB]: ROLE_GROUPS.OPERATIONAL_DAILY,
  [ROUTE_ACCESS_KEYS.TRANSACTIONS_HUB]: ROLE_GROUPS.OPERATIONAL_DAILY,
  [ROUTE_ACCESS_KEYS.FINANCE_HUB]: ROLE_GROUPS.ADMIN_ONLY,
  [ROUTE_ACCESS_KEYS.SYSTEM_HUB]: ROLE_GROUPS.ADMIN_ONLY,
  [ROUTE_ACCESS_KEYS.REPORTS_HUB]: ROLE_GROUPS.ADMIN_ONLY,
  ...
  [ROUTE_ACCESS_KEYS.MONEY_MOVEMENT_LEDGER]: ROLE_GROUPS.ADMIN_ONLY,
...
// - service create profile manual dan guard akses layanan lokal wajib mengikuti aturan yang sama.
// Status:
// - AKTIF untuk penyederhanaan role 2 level.
// - GUARDED: aturan ini harus diselaraskan dengan guard akses layanan lokal; UI guard saja tidak cukup.
// =========================
...
// Status:
// - AKTIF.
// - GUARDED: hide menu bukan security final; route guard dan guard akses layanan lokal tetap wajib.
// =========================
