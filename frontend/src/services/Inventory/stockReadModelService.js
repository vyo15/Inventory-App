...
export const setStockItemReadModelInTransaction = () => ({ skipped: true, reason: "SQLite stock read model tidak memakai Firestore transaction." });
export const setStockItemReadModelInBatch = () => ({ skipped: true, reason: "SQLite stock read model tidak memakai Firestore batch." });
