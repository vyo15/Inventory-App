...
const sqliteOnly = (label = "maintenance") => ({ mode: "sqlite_only", label, warnings: [], destructiveAllowed: false, note: "Firebase reset legacy sudah dihapus. Gunakan backup/restore SQLite backend untuk maintenance data." });
