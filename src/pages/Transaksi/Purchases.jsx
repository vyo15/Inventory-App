    ...
    <>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleSubmitPurchase}>
          ...
          {!isOfflinePurchase ? (
            <>
              <Space className="ims-flex-full-wrap" size={12} wrap>
                <Form.Item
                  name="shippingCost"
                  label="Ongkir"
          ...
          <Form.Item shouldUpdate noStyle>
            {({ getFieldValue }) => {
              ...
              // AKTIF/GUARDED: card ringkasan tetap read-only; class hanya untuk konsistensi token dan tanpa ubah flow submit.
              return (
                <div className="ims-summary-readonly-card">
