...
- Status QA tidak disimpan ke Firebase dan tidak mempengaruhi business data.
...
- [ ] Kembali ke Firebase Mode berjalan tanpa menghapus data local.

## 3. Master data write pilot

- [ ] Firebase → Offline Categories berhasil preview dan pull.
- [ ] Firebase → Offline Customers berhasil preview dan pull.
...
- [ ] Offline → Firebase hanya menampilkan pilihan Categories dan Customers.
- [ ] Delete Firebase dari offline queue tetap diblokir default.
...
- [ ] Conflict tab menampilkan diff Local vs Firebase.
...
- [ ] Dry-run restore tidak mengubah IndexedDB.
...
- [ ] Profit/Loss final tetap Firebase-primary dan tidak memakai local draft/queue pending.
...
- [ ] Stock adjustment tetap online/Firebase-primary dan tidak bisa dilakukan dari snapshot.
- [ ] Finance Cash In/Out tetap Firebase-primary.
- [ ] Dashboard/Report final tetap Firebase-primary.
- [ ] Production Planning/Order/Work Log/BOM/Payroll/HPP tetap Firebase-primary.
